...
import fr.epita.android.gamebox2019.game.HangmanPlayFragment
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        play.setOnClickListener {
            ...
            if (!name.isEmpty()) {
                ...
                fragmentManager!!
                    .beginTransaction()
                    .replace(this@GameDetailFragment.id,
                        HangmanPlayFragment.newInstance(name)
                    )
                    .commit()
                    ...
                    fragmentManager!!
                        .beginTransaction()
                        .replace(this@GameDetailFragment.id,
                            PuzzlePlayFragment.newInstance(name)
                        )
                        .commit()
                }
            }
